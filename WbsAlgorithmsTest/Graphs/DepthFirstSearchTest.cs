...
namespace WbsAlgorithmsTest.Graphs
{
    ...
    public class DepthFirstSearchTest
    {
        ...
        public void SingleComponentTest()
        {
            ...
            CollectionAssert.AreEqual(expected, DephFirstSearch.ExploreIteratively(g, 6));
            CollectionAssert.AreEqual(expected, DephFirstSearch.ExploreRecursively(g, 6));

            // From the vertex 4 we can reach vertices 5 and 6.
            expected = new List<int> { 4, 5, 6 };
            CollectionAssert.AreEqual(expected, DephFirstSearch.ExploreIteratively(g, 4));
            CollectionAssert.AreEqual(expected, DephFirstSearch.ExploreRecursively(g, 4));
        }
