...
namespace WbsAlgorithmsTest.Graphs
{
    ...
    public class DepthFirstSearchTest
    {
        ...
        public void SingleComponentTest()
        {
            ...
            CollectionAssert.AreEqual(expected, DepthFirstSearch.ExploreIteratively(g, 0));
            CollectionAssert.AreEqual(expected, DepthFirstSearch.ExploreRecursively(g, 0));

            // The vertex 5 is the sink. We are not able to reach any other vertices.
            expected = new List<int> { 5 };
            CollectionAssert.AreEqual(expected, DepthFirstSearch.ExploreIteratively(g, 5));
            CollectionAssert.AreEqual(expected, DepthFirstSearch.ExploreRecursively(g, 5));

            // From the vertex 3 we can reach vertices 4 and 5.
            expected = new List<int> { 3, 4, 5 };
            CollectionAssert.AreEqual(expected, DepthFirstSearch.ExploreIteratively(g, 3));
            CollectionAssert.AreEqual(expected, DepthFirstSearch.ExploreRecursively(g, 3));
        }
        ...
        public void MultipleComponentsTest()
        {
            ...
            CollectionAssert.AreEqual(expected, DepthFirstSearch.ExploreIteratively(g, 1));
            CollectionAssert.AreEqual(expected, DepthFirstSearch.ExploreRecursively(g, 1));

            // From vertex 2 we can reach vertices 5, 8, 6, 0, 3 (two components).
            expected = new List<int> { 0, 2, 3, 5, 6, 8 };
            CollectionAssert.AreEqual(expected, DepthFirstSearch.ExploreIteratively(g, 2));
            CollectionAssert.AreEqual(expected, DepthFirstSearch.ExploreRecursively(g, 2));
        }
    }
}
